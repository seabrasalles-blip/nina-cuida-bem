  ...
  return (
    ...
    >
      ...
      <div className="mt-4 bg-violet-50 border-[3px] border-violet-200 rounded-2xl p-5 flex items-center gap-4">
        <div className="shrink-0 w-24 h-24 rounded-2xl bg-white border-[3px] border-violet-300 flex items-center justify-center text-[56px] leading-none shadow-sm">
          {cell.infoIcon ?? "💡"}
        </div>
      ...
      <div className="mt-4 flex justify-end">
        <motion.button
          whileHover={alts.length === 0 || picked !== null ? { scale: 1.04 } : undefined}
          whileTap={alts.length === 0 || picked !== null ? { scale: 0.96, translateY: 3 } : undefined}
          disabled={alts.length > 0 && picked === null}
          onClick={onDone}
